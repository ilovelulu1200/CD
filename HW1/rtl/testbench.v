...
// `ifdef I0
    // `define Inst_I  "./INST0_I.dat"
    // `define Inst_O  "./INST0_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I1
    // `define Inst_I  "./INST1_I.dat"
    // `define Inst_O  "./INST1_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I2
    // `define Inst_I  "./INST2_I.dat"
    // `define Inst_O  "./INST2_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I3
    // `define Inst_I  "./INST3_I.dat"
    // `define Inst_O  "./INST3_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I4
    // `define Inst_I  "./INST4_I.dat"
    // `define Inst_O  "./INST4_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I5
    // `define Inst_I  "./INST5_I.dat"
    // `define Inst_O  "./INST5_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I6
    // `define Inst_I  "./INST6_I.dat"
    // `define Inst_O  "./INST6_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I7
    // `define Inst_I  "./INST7_I.dat"
    // `define Inst_O  "./INST7_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 0
// `elsif I8
    `define Inst_I  "./INST8_I.dat"
    `define Inst_O  "./INST8_O.dat"
    `define PAT_NUM 40
    `define FLAG 1    
// `elsif I9
    // `define Inst_I  "./INST9_I.dat"
    // `define Inst_O  "./INST9_O.dat"
    // `define PAT_NUM 40
    // `define FLAG 1
// `endif
